...
import lastSnap from  "./lastSnap.png"
import Header from "./concepts/Layout/Header";
import Footer from "./concepts/Layout/Footer";
  ...
  return (
    ...
    <div>
     <Header/>
      ...
      <p className="text-2xl text-center mt-8 font-semibold">The folks we work with</p>
